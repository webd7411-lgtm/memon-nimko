...
<body>
  ...
  <div class="receipt-container">
    @php
      $receiptBranch = $return->branch 
          ?? ($return->branch_id ? \App\Models\Branch::find($return->branch_id) : null)
          ?? $return->sale?->branch 
          ?? ($return->sale?->branch_id ? \App\Models\Branch::find($return->sale->branch_id) : null)
