...
<div class="pos-right">
    ...
    <div class="ord-sum">
        ...
        <div class="sr"><span>Extra Disc. (%)</span>
            @php $discPct = ($sale->total_bill_amount > 0) ? ($sale->total_extradiscount / $sale->total_bill_amount * 100) : 0; @endphp
            <input type="number" id="extraDisc" class="disc-i" value="{{ number_format($discPct, 2, '.', '') }}" min="0" placeholder="%" step="any">
            <input type="hidden" id="hExtraDisc" name="total_extra_cost" value="{{ $sale->total_extradiscount }}">
        </div>
