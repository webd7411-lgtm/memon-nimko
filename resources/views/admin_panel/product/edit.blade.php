                                ...
                                <div class="pz-panel active" data-panel="1">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                                            <label class="pz-label"><i class="las la-balance-scale"></i> Unit</label>
                                            <select name="unit" class="pz-control">
                                            ...
                                            <table class="table pz-bom-table" id="bomTable">
                                                ...
                                                <tbody id="bomBody">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="number" step="0.001" min="0" name="qty_per_unit[]" class="form-control bom-qty-input" value="{{ $bom->qty_per_unit }}" placeholder="e.g. 0.250">
                                                        </td>
