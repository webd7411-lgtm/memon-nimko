...
#catModal .modal-header .btn-close { filter: brightness(0) invert(1); opacity: .6; transition: opacity .2s; }
#catModal .modal-header .btn-close:hover { opacity: 1; }
#catModal .modal-header h5 { font-weight: 700; font-size: 1rem; }

#catModal .modal-body { padding: 1.5rem; }
...
.cat-lbl i { color: var(--pc-accent); font-size: .82rem; }
...
.cat-fld::placeholder { color: var(--pc-text-muted); font-weight: 400; }
...
.cat-btn-s:hover { border-color: #c8d0dd; color: var(--pc-text); }
...
@media (max-width: 767.98px) {
  ...
  /* ── DataTables length / search controls: un-clipped stack ── */
  .pc-page .dataTables_wrapper { display: block !important; width: 100% !important; overflow: visible !important; }
  .pc-page .dataTables_wrapper .row {
    margin-left: 0 !important; margin-right: 0 !important;
    display: block !important; width: 100% !important;
  }
  .pc-page .dataTables_wrapper [class*="col-"] { padding-left: 0 !important; padding-right: 0 !important; max-width: 100% !important; flex: 0 0 100% !important; width: 100% !important; }
  .pc-page .dataTables_length,
  .pc-page .dataTables_filter {
    float: none !important; clear: both !important;
    width: 100% !important; max-width: 100% !important;
    text-align: left !important; margin: 0 0 .6rem !important; padding: 0 .35rem !important;
  }
  .pc-page .dataTables_length label,
  .pc-page .dataTables_filter label {
    display: flex !important; flex-wrap: wrap !important; align-items: center !important;
    gap: .45rem; margin: 0 !important; font-size: .74rem !important; font-weight: 600;
    color: var(--pc-text-sec); white-space: normal !important; max-width: 100%;
  }
  .pc-page .dataTables_length select,
  .pc-page .dataTables_filter input {
    width: auto !important; min-width: 0 !important; max-width: 100%;
    flex: 1 1 auto; height: 36px; font-size: .8rem; border-radius: 8px;
    padding: .25rem .6rem; border: 1.5px solid var(--pc-border);
    background: #fff; outline: none; box-sizing: border-box; margin: 0 !important;
  }
  ...
  <div class="container-fluid px-3 px-md-4 py-3">
    ...
    <div class="pc-hdr">
      <div class="d-flex align-items-center gap-3">
        ...
        <span class="hdr-badge d-none d-sm-inline">{{ count($category) }} Records</span>
      </div>
      <button type="button" class="pc-btn pc-btn-primary mt-2 mt-md-0" data-bs-toggle="modal" data-bs-target="#catModal" id="reset">
    ...
    <div class="pc-card">
      <div class="pc-card-body">
        <div class="pc-tbl-wrap">
          <table id="catTable" class="pc-tbl">
            <thead>
              <tr>
            ...
            <tbody>
              ...
              <tr>
                <td class="pc-id id" data-label="ID">{{ $cat->id }}</td>
                <td class="pc-name name" data-label="Name">{{ $cat->name }}</td>
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="catModalLabel"><i class="bi bi-tag me-1"></i> Category</h5>
          ...
          <form class="myform" action="{{ route('store.category') }}" method="POST">
            ...
            <div class="modal-body">
              <div class="mb-2">
                <label class="cat-lbl"><i class="bi bi-type-bold"></i>Title</label>
                <input type="text" name="name" class="cat-fld" id="name" placeholder="Enter category name" />
              </div>
            </div>
            <div class="modal-footer">
              <button type="button" class="cat-btn-s" data-bs-dismiss="modal">Cancel</button>
              <input type="submit" class="cat-btn-p" value="Save" />
            </div>
          </form>
        </div>
      </div>
